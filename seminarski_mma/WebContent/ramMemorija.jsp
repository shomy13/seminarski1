...
<%
	ArrayList<ramMemorija> lp = null;

	ProizvodiDAO od = new ProizvodiDAO();
	
	lp=od.selectramMemorija();
...
<table  width="100%" height="100px" align="left" >
		...
		<tr >
			...
			<td height="70px"><h3><%=pom.getBrzinaRada() %></h3></td>
			<td height="70px"><h3><%=pom.getCena() %></h3></td>
			
			
			<td  height="70px" ><input type="button" onclick="location.href='ServletKorpa?rsifra=<%=pom.getSifra() %>'" value="dodaj"></td>
