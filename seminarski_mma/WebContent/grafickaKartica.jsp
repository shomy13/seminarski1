...
<%
	ArrayList<grafickaKartica> lp = null;

	ProizvodiDAO od = new ProizvodiDAO();
	
	lp=od.selectgrafickaKartica();
...
<table  width="100%" height="100px" align="left" >
		...
		<tr >
			...
			<td height="70px"><h3><%=pom.getMemorija() %></h3></td>
			<td height="70px"><h3><%=pom.getCena() %></h3></td>
		
			<td  height="70px" width="130px"><input type="button" onclick="location.href='ServletKorpa?gsifra=<%=pom.getSifra() %>'" value="dodaj"></td>
